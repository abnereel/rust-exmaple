...
use tonic::{transport::Server, Extensions, Request, Response, Result, Status};
...
impl Chat for ChatService {
    ...
    type GetMessagesStream =
        Pin<Box<dyn Stream<Item = std::result::Result<ChatMessage, Status>> + Send>>;
    async fn get_messages(
        ...
        tokio::spawn(async move {
            // TODO: filter out message I'm not interested in
